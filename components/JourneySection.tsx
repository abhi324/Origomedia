              ...
              >
                <div className="relative mb-12">
                   ...
                   <div className="relative w-28 h-28 bg-white rounded-[2.5rem] flex items-center justify-center shadow-[0_20px_40px_-12px_rgba(0,0,0,0.05)] border border-gray-100 z-10 group-hover:-translate-y-2 group-hover:shadow-[0_32px_64px_-16px_rgba(74,99,87,0.15)] transition-all duration-700">
                      ...
                      {/* Step Number Badge */}
                      <div className="absolute -top-3 -right-3 w-10 h-10 bg-[#4A6357] text-white font-playfair font-bold text-sm flex items-center justify-center rounded-2xl border-4 border-[#FCF9F5]">
                        0{i + 1}
                      </div>
                   </div>
                </div>

                <h4 className="text-3xl font-playfair font-bold text-gray-900 mb-6">{item.step}</h4>
